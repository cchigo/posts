...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.PostsViewHolder> {
    ...
    class PostsViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(ArrayList<Post> postModels) {
            ...
            if (isListContainFavorite(postModels)) {
                postItemBinding.favBtn.setImageResource(R.drawable.ic_baseline_favorite_24);
            } else {
                postItemBinding.favBtn.setImageResource(R.drawable.ic_favorite_border);
            }
            postItemBinding.favBtn.setOnClickListener(v -> {
                listener.onFavouriteClick(postModels);
                postItemBinding.favBtn.setImageResource(R.drawable.ic_baseline_favorite_24);
            });
    ...
    private Boolean isListContainFavorite(ArrayList<Post> postModels) {
